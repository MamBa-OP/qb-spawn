...
function setupLocations(locations, myHouses) {
    ...
    setTimeout(function(){
        ...
        $.each(locations, function(index, location){
            $(parent).append('<div class="normal" id="location" data-location="'+location.location+'" data-type="normal" data-label="'+location.label+'"><p><span id="'+location.location+'">'+location.label+'</span></p></div>')
        });
